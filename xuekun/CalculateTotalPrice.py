...
if not isOilOption and not isGasOption:
    ...
    if isOilOption:
        ...
        product = "Gas"
        litres = float(input(" Please enter the number of litres of gas:"))
        price_before = float(litres * 1.07)
    ...
    print(
        f"{product}      {litres}         {price_before}            {price_after}           {gst_money}   {total_price}")
    print("---------------------------------------------------------------------------------")
